...
import { AppBar, Divider, Grid, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Toolbar } from '@mui/material';
            ...
            <Container sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <TableContainer sx={{ width: 1920 }} >
                    <Table sx={{ width: 1920 }}>
                        <TableHead>
                            <TableRow>
                                <TableCell color="textPrimary" sx={{ textAlign: 'center', width: 430, fontSize: 35, background: 'Black' }}>Eliminar</TableCell>
